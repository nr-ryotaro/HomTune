...
class DeviceCard extends StatelessWidget {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        device.maintenance?.nextMaintenance ?? '-',
                        style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
                          color: Color(0xFF333333),
  ...
  Map<String, String>? _getMaintenanceStatus() {
    ...
    final highPriorityAlert =
        device.maintenance!.alerts.firstWhere((a) => a.priority == 'high',
            orElse: () => Alert(
                  type: '',
                  message: '',
                  priority: '',
    ...
    final mediumPriorityAlert =
        device.maintenance!.alerts.firstWhere((a) => a.priority == 'medium',
            orElse: () => Alert(
                  type: '',
                  message: '',
                  priority: '',
  ...
  Map<String, String>? _getWarrantyStatus() {
    ...
    if (device.warranty!.manufacturer!.expired) {
      return {
        'type': 'default',
        'message': '保証切れ',
      };
